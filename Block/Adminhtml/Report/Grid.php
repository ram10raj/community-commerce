...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
		try{
		   ...
		   $collection->addExpressionFieldToSelect('charity_total_amount', 'SUM(charity_total_amount)', array('charity_total_amount'));
		   $collection->addFieldToFilter('charity_id', ['neq' => '']);		   
		   $collection->getSelect()->group('charity_id');
