...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Save Charity'));
        $this->buttonList->update('delete', 'label', __('Delete Charity'));
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('checkmodule_checkmodel')->getId()) {
            return __("Edit Charity '%1'", $this->escapeHtml($this->_coreRegistry->registry('checkmodule_checkmodel')->getTitle()));
        } else {
            return __('New Charity');
        }
    }
}
